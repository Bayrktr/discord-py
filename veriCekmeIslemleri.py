...
def gameNews():
    ...
    def newsContent():
        ...
        for x in newContentList:
            content += x
        return title, content, pictureLink(), contentLink
...
def weatherDatas(city):
    ...
    if a.status_code == 404:
        return "Bu isme sahip bir şehir bilmiyorum farklı bir gezegende olmasın :smile:"
    else:
        weatherEmoji = ''
        color = ''
        ...
        if datas[0][2] == 'Açık':
            ...
            color = 0x95a5a6
        elif datas[0][2] == "Orta şiddetli Yağmur":
            weatherEmoji = ':cloud_rain:'
            color = 0x95a5a6
        elif datas[0][2] == "Parçalı Az Bulutlu":
            weatherEmoji = ':cloud_rain:'
            color = 0x95a5a6
        else:
